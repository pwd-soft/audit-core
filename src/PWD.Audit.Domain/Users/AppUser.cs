...
namespace PWD.Audit.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AttendanceDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AttendanceEfCoreEntityExtensionMappings to extend the IdentityUser entity
